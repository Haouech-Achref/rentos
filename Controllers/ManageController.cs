...
using Rentos.Models;
using Rentos.Models.ManageViewModels;
using Rentos.Models.RentViewModels;
using Rentos.Services;
    ...
    public class ManageController : Controller
    {
        ...
        public IActionResult Rents()
        {
            if (_signInManager.IsSignedIn(User))
            {
                ...
                var rents = _context.Rent.Where(c => c.User_UserId == userId).ToList();
                var rentList = new List<RentListViewModel>();
                foreach(var item in rents)
                {   
                    rentList.Add(new RentListViewModel() { Rent = item, Car = _context.Car.Find(item.Car_CarId)  });
                }
